  ...
  return (
    <article className={styles.container} ref={elementRef}>
      <div className={styles.imgWrap}>
        <img className={styles.imgBox} src="/images/tom.png" alt="leetaehoon" />
      </div>
      <div className={styles.Wrap}>
        <div className={styles.introWrap}>
          <h2 className={styles.introTitle}>
            안녕하세요 <span className={styles.accent}>개발자</span>{" "}
            이태훈입니다.
          </h2>
      ...
      <div className={styles.textContainer}>
        <Title font="ABOUT ME" lineColor="gray" color="#0000ed" />
        <ul className={styles.textWrap}>
          ...
          <li className={styles.textList}>
            ...
            <p>
              ...
              해야한다고 생각합니다. 더 나아가 세상에서 나오는 불만이라는
              피드백을 취합하여 반영할 수 있는 개발자가 되고 싶습니다.
            </p>
          </li>
        </ul>
