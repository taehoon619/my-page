          ...
          <ul className={styles.textWrap}>
            <li className={styles.textBox}>
              ...
              <p className={styles.text}>
                ...
                개발 역량을 향상시켜 나가고 있습니다. 새로운 도전과 함께 성장할
                수 있는 기회가 있다면, 적극적으로 참여하고 기여하고 싶습니다.
              </p>
            </li>
            <li>
              ...
              <p className={styles.text}>
                ...
                <br />
                <br />
                개발자가 되어서 내 손으로 무언가를 개발할 수 있고, 그 범위가
                무한하다는 것이 너무 멋진 일이라고 생각합니다.
              </p>
            </li>
            <li>
              <h2 className={styles.title}>Q3. 개발자로서 목표</h2>
              <p className={styles.text}>
                내가 좋아하는 제품을 만들고, 그를 통해서 사용자들의 더 나은 삶에
                기여하는 개발자가 되고 싶습니다.
                <br />
                <br />
                ...
                싶은 것을 할 수 있을 때까지 새로운 것에 대해 호기심과 도전의식을
                가지고 공부하고 성장해야 한다는 것입니다.
                <br />
                <br />
                사용자들에게 더 나은 서비스를 제공하기 위한 필수 덕목은
                소통이라고 생각합니다. 사용자와의 대화 뿐만 아니라 팀원들과
                협업하려는 마음, 배려와 이해를 바탕으로 한 의사소통이라고
                생각합니다.
                <br />
                <br />더 나은 제품을 만들고 더 나은 삶에 기여하기 위해 기술적
                성장과 소통 능력의 개발을 최우선으로 하는 개발자가 되고
                싶습니다.
              </p>
            </li>
          </ul>
